      ...
      <div className="min-h-screen bg-[#000000] px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <header className="mb-12">
            <h1 className="text-[36px] font-extrabold leading-tight text-white uppercase tracking-tight">Student Dashboard</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
            <Link href="/student/borrows" className="bg-[#111111] p-8 rounded-2xl border border-[#222222] hover:border-[#444444] transition-all group">
              <div className="flex justify-between items-start mb-10">
                <div className="text-[10px] text-[#666666] uppercase tracking-[0.2em] font-semibold">ACTIVE BORROWS</div>
                <BookMarked size={16} className="text-[#666666] group-hover:text-white transition-colors" />
              </div>
              <div className="text-[48px] font-extrabold text-white leading-none mb-4">{activeBorrows.length}</div>
            ...
            <Link href="/student/borrows?tab=fines" className="bg-[#111111] p-8 rounded-2xl border border-[#222222] hover:border-[#444444] transition-all group">
              <div className="flex justify-between items-start mb-10">
                <div className="text-[10px] text-[#666666] uppercase tracking-[0.2em] font-semibold">OUTSTANDING FINES</div>
                <DollarSign size={16} className="text-[#666666] group-hover:text-white transition-colors" />
              </div>
              <div className="text-[48px] font-extrabold text-white leading-none mb-4 flex items-baseline gap-2">
                {totalOwed} <span className="text-[14px] text-[#666666] font-semibold">EGP</span>
              </div>
              <div className="flex items-center justify-between mt-6">
                <p className="text-[12px] text-[#888888]">
            ...
            <Link href="/student/borrows?tab=history" className="bg-[#111111] p-8 rounded-2xl border border-[#222222] hover:border-[#444444] transition-all group">
              <div className="flex justify-between items-start mb-10">
                <div className="text-[10px] text-[#666666] uppercase tracking-[0.2em] font-semibold">BOOKS RETURNED</div>
                <BookOpen size={16} className="text-[#666666] group-hover:text-white transition-colors" />
              </div>
              <div className="text-[48px] font-extrabold text-white leading-none mb-4">
                {borrows.filter(b => b.status === BorrowStatus.RETURNED).length}
              </div>
              <div className="flex items-center justify-between mt-6">
                <p className="text-[12px] text-[#888888]">Your lifetime reading impact</p>
                <ArrowRight size={14} className="text-[#444444] group-hover:text-white transition-colors" />
              </div>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <div className="bg-[#111111] border border-[#222222] rounded-2xl overflow-hidden h-full">
                <div className="p-6 border-b border-[#222222] flex justify-between items-center bg-[#151515]">
                  ...
                  <Link href="/student/borrows" className="text-[10px] font-extrabold text-[#666666] hover:text-white uppercase tracking-widest transition-colors">
                    See All
                  </Link>
                </div>
                <div className="p-6">
                  {pendingBorrows.length === 0 ? (
                    <div className="text-center py-16 flex flex-col items-center">
                      ...
                      <p className="text-[13px] text-[#666666] font-medium uppercase tracking-widest">No pending requests</p>
                    </div>
                  ) : (
                      ...
                      {pendingBorrows.map(b => (
                        <div key={b.id} className="flex items-center justify-between p-4 bg-[#1a1a1a] border border-[#222222] rounded-xl hover:border-[#333333] transition-colors">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <h4 className="text-[14px] text-white font-semibold">{b.book.title}</h4>
            ...
            <div className="space-y-6">
              <div className="bg-[#111111] border border-[#222222] rounded-2xl p-8">
                <h3 className="text-[10px] font-extrabold text-[#666666] uppercase tracking-[0.2em] mb-6">Library Tip</h3>
                ...
                <Link href="/books" className="flex items-center justify-center w-full mt-8 py-3 rounded-lg bg-white hover:bg-[#eeeeee] text-black text-[11px] font-extrabold uppercase tracking-widest transition-all">
                  Browse Catalog
                </Link>
              </div>

              <div className="bg-[#111111] border border-[#222222] rounded-2xl p-8">
                <h3 className="text-[10px] font-extrabold text-[#666666] uppercase tracking-[0.2em] mb-6">System Health</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-[#1a1a1a] rounded-lg border border-[#222222]">
                    <span className="text-[11px] text-[#888888] font-semibold uppercase tracking-wider">Auto-Fine Service</span>
                    <span className="w-1.5 h-1.5 rounded-full bg-white shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#1a1a1a] rounded-lg border border-[#222222]">
                    <span className="text-[11px] text-[#888888] font-semibold uppercase tracking-wider">Live Notifications</span>
                    <span className="w-1.5 h-1.5 rounded-full bg-white shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
                  </div>
                </div>
              </div>
