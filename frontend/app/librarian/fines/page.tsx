      ...
      <RoleGuard allowedRoles={['LIBRARIAN', 'ADMIN']}>
        <AdminLayout showSearch={true} searchPlaceholder="Search archive database...">
          <header className="mb-10">
            <h1 className="text-[36px] font-extrabold text-white leading-tight">Fines Management</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            <div className="bg-[#1a1a1a] border border-[#222222] rounded-[10px] p-[32px]">
              <div className="text-[10px] text-[#666666] uppercase tracking-[0.2em] mb-5 font-semibold">UNPAID FINES</div>
              <div className="flex items-baseline">
                <span className="text-[52px] font-extrabold text-white leading-none">{stats.unpaidFinesAccounts}</span>
                <span className="text-[11px] text-[#555555] uppercase font-semibold ml-3">ACCOUNTS</span>
              </div>
            </div>

            <div className="bg-[#1a1a1a] border border-[#222222] rounded-[10px] p-[32px]">
              <div className="text-[10px] text-[#666666] uppercase tracking-[0.2em] mb-5 font-semibold">TOTAL COLLECTED</div>
              <div className="flex items-baseline">
                <span className="text-[52px] font-extrabold text-white leading-none">${stats.totalFinesCollected.toLocaleString()}</span>
                <span className="text-[11px] text-[#555555] uppercase font-semibold ml-3">FISCAL YEAR</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center border-b border-[#222222] pb-0 mb-12">
            <div className="flex items-center gap-2">
              <button className="bg-white text-black text-[11px] font-semibold uppercase rounded-[20px] px-[18px] py-[6px] tracking-wide -mb-px">
                ALL OUTSTANDING
              </button>
              <button className="text-[#666666] text-[11px] font-semibold uppercase px-[18px] py-[6px] tracking-wide hover:text-white transition-all">
                OVERDUE (&gt;30 DAYS)
              </button>
              <button className="text-[#666666] text-[11px] font-semibold uppercase px-[18px] py-[6px] tracking-wide hover:text-white transition-all">
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            {isLoading ? (
              ...
              <>
                ...
                <h2 className="text-[28px] font-extrabold text-white mb-4">All Fines Settled</h2>
                ...
                <div className="flex gap-4">
                  <button className="bg-transparent border border-[#444444] text-white text-[12px] font-semibold uppercase rounded-[6px] px-[24px] py-[10px] hover:border-[#666666] transition-all">
                    VIEW HISTORY
                  </button>
                  <button className="bg-white text-black text-[12px] font-semibold uppercase rounded-[6px] px-[24px] py-[10px] hover:bg-[#eeeeee] transition-all">
                    GENERATE REPORT
                  </button>
                </div>
              </>
