  ...
  return (
    <div className="flex flex-col bg-[#000000] min-h-screen ">
      ...
      <section className="pt-32 pb-24 px-10 text-center flex flex-col items-center">
        <h1 className="text-[56px] font-extrabold tracking-tight leading-tight flex flex-col">
        ...
        <div className="flex items-center gap-4 mt-12">
          <Link
            href="/books"
            className="text-[13px] font-medium uppercase tracking-wider bg-transparent border border-white text-white px-[28px] py-[12px] rounded-[6px] hover:bg-white hover:text-black transition-all flex items-center gap-2"
          >
            EXPLORE CATALOG <ArrowRight size={14} />
          </Link>
          <Link
            href="/books"
            className="text-[13px] font-medium uppercase tracking-wider bg-transparent border border-[#444444] text-[#888888] px-[28px] py-[12px] rounded-[6px] hover:border-[#666666] hover:text-white transition-all"
          >
            BROWSE BOOKS
          </Link>
        </div>
      ...
      <section className="bg-[#111111] border-y border-[#222222] py-[32px]  px-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col items-center lg:items-start">
            <span className="text-[36px] font-extrabold text-white tracking-tight">1.2M</span>
            <span className="text-[11px] text-[#666666] uppercase tracking-[0.15em] font-medium mt-1">TOTAL VOLUMES</span>
          </div>
          <div className="flex flex-col items-center lg:items-start">
            <span className="text-[36px] font-extrabold text-white tracking-tight">45k</span>
            <span className="text-[11px] text-[#666666] uppercase tracking-[0.15em] font-medium mt-1">DIGITAL JOURNALS</span>
          </div>
          <div className="flex flex-col items-center lg:items-start">
            <span className="text-[36px] font-extrabold text-white tracking-tight">24/7</span>
            <span className="text-[11px] text-[#666666] uppercase tracking-[0.15em] font-medium mt-1">SYSTEM UPTIME</span>
          </div>
          <div className="flex flex-col items-center lg:items-start">
            <span className="text-[36px] font-extrabold text-white tracking-tight">100%</span>
            <span className="text-[11px] text-[#666666] uppercase tracking-[0.15em] font-medium mt-1">ACADEMIC PRECISION</span>
          </div>
        </div>
      </section>
    </div>
      ...
      <section className="pb-32 px-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-[#111111] border border-[#222222] rounded-[12px] p-[28px] hover:border-[#444444] transition-all">
            ...
            <h3 className="text-[18px] font-bold text-white mt-[20px]">Advanced Search</h3>
          ...
          <div className="bg-[#111111] border border-[#222222] rounded-[12px] p-[28px] hover:border-[#444444] transition-all">
            ...
            <h3 className="text-[18px] font-bold text-white mt-[20px]">Digital Archive</h3>
            <p className="text-[14px] text-[#666666] leading-relaxed mt-[8px]">
          ...
          <div className="bg-[#111111] border border-[#222222] rounded-[12px] p-[28px] hover:border-[#444444] transition-all">
            ...
            <h3 className="text-[18px] font-bold text-white mt-[20px]">Borrowing History</h3>
            <p className="text-[14px] text-[#666666] leading-relaxed mt-[8px]">
          ...
          <div className="bg-[#111111] border border-[#222222] rounded-[12px] p-[28px] hover:border-[#444444] transition-all">
            ...
            <h3 className="text-[18px] font-bold text-white mt-[20px]">Smart Reservations</h3>
            <p className="text-[14px] text-[#666666] leading-relaxed mt-[8px]">
      ...
      <section className="pb-32 px-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="relative rounded-[12px] overflow-hidden aspect-video bg-[#1a1a1a]">
            ...
            />
            <div className="absolute bottom-6 left-6 bg-[#000000] border border-[#333333] px-4 py-2 rounded-full text-white text-[11px] font-semibold uppercase tracking-wider">
              CURATED COLLECTIONS
            </div>
          </div>
          <div>
